...
export const VTS = sqliteTable(
  ...
  (table) => [index("vts_vehicle_id_index").on(table.vehicle_id)]
);
...
export const MESSAGES = sqliteTable(
  ...
  (table) => [index("messages_chat_id_index").on(table.chat_id),unique("messages_unique_index").on(table.chat_id,table.message_id)]
);
